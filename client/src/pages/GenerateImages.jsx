...
const GenerateImages = () => {
  ...
  text-slate-700'>
    ...
    border-gray-200'>
        ...
        rows={4}   className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border
         border-gray-300' placeholder='Describe what you want to see in image...'required/>
         ...
         <div>
            ...
            <div className='my-6 flex items-center gap-2'>
              ...
              transition-all duration-300 peer-checked:translate-x-4'></span>
              </label>
         ...
         to-[#04FF50] text-white px-4 py-2 mt-6 text-sm rounded-1g cursor-pointer'>
          
          {
            
            loading?<span className='w-4 h-4 my-1 rounded-full border-2
           border-white border-t-transparent animate-spin'></span>:<Image className='w-5'/>
          }
          Generate Image
         </button>
     </form>
