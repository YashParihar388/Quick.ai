  ...
  text-slate-700'>
    ...
    border-gray-200'>
        ...
        <p className='text-xs text-gray-500 font-light mt-1'>Supports PDF resume Only.</p>
         ...
         to-[#009BB3] text-white px-4 py-2 mt-6 text-sm rounded-1g cursor-pointer'>
          {
            
            loading?<span className='w-4 h-4 my-1 rounded-full border-2
           border-white border-t-transparent animate-spin'></span>:<FileText className='w-5'/>
          }
          Review Resume
         </button>
     </form>
    ...
    min-h-96 max-h-[600px]'>
      <div className='flex items-center gap-3'>
        ...
        <h1 className='text-lg font-semibold'>Processed Resume</h1>
      </div>
          {
            !content?(<div className='flex-1 flex justify-center items-center'>
          <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
          <FileText className='w-9 h-9'/>
          <p className='text-center'>Upload an Resume and click "Review Resume" to get started</p>
          </div>
          </div>):(
