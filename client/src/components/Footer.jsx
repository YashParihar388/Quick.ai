...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
               Experience the power of AI with quick AI. <br></br>Transform 
               your content creation with our suite of premium Aitools.Write articles,
                generate images, and enhance your content effortlessly.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 ©YashParihar. All Right Reserved.
    </p>
</footer>
  )
}
