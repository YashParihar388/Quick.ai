  ...
  return (
    ...
    min-h-screen'>
      <div className='text-center mb-6'>
        ...
        font-semibold mx-auto loading-[1.2]'>Create Amazing contents <br/>with<span className='text-primary'> Ai tools</span></h1>
      ...
      <div className= 'flex items-center gap-4 mt-8 mx-auto text-gray-600'>
        <img src={assets.user_group} alt='' className='h-8' />Trusted by
        over 10K+ people
      </div>
