...
import { Eraser, FileText, Hash, House,Image, LogIn, LogOut, Scissors, SquarePen, Users } from 'lucide-react';
...
const Sidebar = ({sidebar,setSidebar}) => {
  ...
  return (
    <div className={`mt-5 w-60 bg-white border-r border-gray-200 flex flex-col h-screen justify-between items-center
    max-sm:absolute top-14 bottom-0 transition-all duration-300 ease-in-out ${sidebar ? 'translate-x-0' : '-translate-x-full sm:translate-x-0'}`}>
